...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4666287783906201352L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentCreatedEvent\",\"namespace\":\"com.project.payment.event\",\"fields\":[{\"name\":\"status\",\"type\":\"string\"}]}");
   ...
   */
  public PaymentCreatedEvent(java.lang.CharSequence status) {
    this.status = status;
  }
   ...
   */
  public static com.project.payment.event.PaymentCreatedEvent.Builder newBuilder() {
    return new com.project.payment.event.PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static com.project.payment.event.PaymentCreatedEvent.Builder newBuilder(com.project.payment.event.PaymentCreatedEvent.Builder other) {
    if (other == null) {
      return new com.project.payment.event.PaymentCreatedEvent.Builder();
    } else {
      return new com.project.payment.event.PaymentCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static com.project.payment.event.PaymentCreatedEvent.Builder newBuilder(com.project.payment.event.PaymentCreatedEvent other) {
    if (other == null) {
      return new com.project.payment.event.PaymentCreatedEvent.Builder();
    } else {
      return new com.project.payment.event.PaymentCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.project.payment.event.PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.project.payment.event.PaymentCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.status)) {
        this.status = data().deepCopy(fields()[0].schema(), other.status);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.payment.event.PaymentCreatedEvent.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.payment.event.PaymentCreatedEvent.Builder clearStatus() {
      status = null;
